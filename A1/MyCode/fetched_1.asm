from: https://www.chegg.com/homework-help/questions-and-answers/lc3-write-lc-3-assembly-language-program-read-one-string-b-check-whether-string-palindrome-q56071775
  .ORIG   x3100
